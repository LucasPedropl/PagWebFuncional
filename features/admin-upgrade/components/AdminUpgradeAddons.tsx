    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 md:p-6 space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Marque o que quer liberar. Depois do POST, o time PagWeb vê a solicitação e desbloqueia.
          Até lá você cadastra cobranças normalmente; PIX/boleto dos clientes e WhatsApp só após
          aprovação.
        </p>
      </div>
